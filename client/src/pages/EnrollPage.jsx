      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 md:px-10 pt-12 md:pt-16 pb-20">
        ...
        >
          ...
          <form className="grid md:grid-cols-2 gap-6">
            {/* Child Name */}
            <div>
              <label className="text-gray-700 font-medium">Child's Full Name</label>
              <input
                type="text"
                required
            ...
            <div>
              ...
              <input
                type="text"
                required
                className="w-full mt-2 px-4 py-3 rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-purple-400 outline-none"
