...
export default function FloatingShapes() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <Sparkles className="absolute top-40 left-1/2 shape-xl text-orange-400 animate-bright-spin opacity-90" />
      ...
      <PartyPopper className="absolute top-52 right-1/4 shape-lg text-purple-500 animate-bounce-slower drop-shadow-xl" />
      ...
      {/* 🪐 Planet */}
      <Circle className="absolute top-[30%] left-[70%] shape-xl text-blue-500 animate-bright-spin opacity-80" />
    </div>
  );
}
