	...
	return (
		<>
			...
			>
				...
				{/* Remove large left padding here — spacer inside the row will reserve space */}
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					{/* NAVBAR ROW */}
					<div className="flex justify-between items-center py-4 gap-1">
						{/* Left spacer to match floating logo width (hidden on small screens) */}
						<div className="hidden md:block w-44 lg:w-56 flex-shrink-0" aria-hidden="true" />
